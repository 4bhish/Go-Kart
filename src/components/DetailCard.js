    ...
    <div className="product__detail__content">
      ...
      <div className="product__detail__info">
        ...
        {cart.includes(product) ? (
          <Link style={{ backgroundColor: 'green', textAlign: 'center' }} className="action__button" to="/cart">
            Go to Cart
          </Link>
        ) : (
          <button className="action__button" onClick={loginStatus ? () => handleAddToCart(product) : alertFunc}>
            Add to Cart
          </button>
        )}
      </div>
